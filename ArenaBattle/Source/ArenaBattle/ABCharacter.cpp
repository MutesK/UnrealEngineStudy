...
void AABCharacter::Turn(float NewAxisValue)
{
	...
	{
	case EControlMode::GTA:
		AddControllerYawInput(NewAxisValue);	// Yaw - Z축 회전
		break;
	}
}
void AABCharacter::LookUp(float NewAxisValue)
{
	...
	{ 
	case EControlMode::GTA:
		AddControllerPitchInput(NewAxisValue);	// Pitch - Y축 회전
		break;
	}
}
...
void AABCharacter::SetControlMode(EControlMode ControlMode)
{
	...
	switch (ControlMode)  // GTA Type Control
	{
	case EControlMode::GTA:
...
{
	ABLOG(Warning, TEXT("View Changed"));
